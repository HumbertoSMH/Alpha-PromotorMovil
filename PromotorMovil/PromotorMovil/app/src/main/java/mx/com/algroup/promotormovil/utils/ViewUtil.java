...
import mx.com.algroup.promotormovil.controller.FotoListaActivity;
import mx.com.algroup.promotormovil.controller.MainLoginActivity;
...
public class ViewUtil {
    ...
    public static void redireccionarALogin(Activity origen){
        ...
        Intent intentToRedirect = new Intent( origen, MainLoginActivity.class );
